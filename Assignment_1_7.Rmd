...
colnames(score_eval) <- c("AIC", "BIC", "MSE", "Average of 3")
score_eval
...
df_numerical_data_only_rq <- df_rq %>%
  select(-loan_intent, -occupation_status)
view(df_numerical_data_only_rq)

correlation_matrix_numerical_rq <- cor(df_numerical_data_only_rq)
